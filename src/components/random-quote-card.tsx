...
export const RandomQuoteCard = () => {
  const [quote, setQuote] = useState<string>(funnyNonsenseQuotes[0]);

  return (
    <section className="w-full px-4 sm:px-6 pt-6 sm:pt-8 pb-10">
      <div className="relative overflow-hidden rounded-2xl border border-neutral-300/70 bg-neutral-700/20 dark:bg-neutral-400/20  p-5 shadow-xl dark:border-neutral-700/80 dark:from-neutral-900 dark:via-slate-900 dark:to-neutral-950 sm:p-6">
        ...
        {/*  bg-yellow-300/35 blur-2xl dark:bg-cyan-500/25 */}
        <div className="pointer-events-none absolute -bottom-16 -left-16 h-44 w-44 rounded-full " />
        {/* bg-pink-300/35 blur-2xl dark:bg-rose-500/25 */}
